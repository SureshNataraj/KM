          ...
          <td> <form name="frm_product" method="post" action="<%=action_page %>" onsubmit="return validate_add()">
              <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr> 
                  ...
                  <td><input name="txt_image_at" type="text" id="txt_image_at" onFocus="blur()">
                  </td>
                </tr>
                <tr>
                  <td><font size="2" face="Verdana">File Attachment</font></td>
                  <td><input name="txt_file_at" type="text" id="txt_file_at" onFocus="blur()"></td>
                </tr>
                <%end if %>
              </table>
            </form></td>
