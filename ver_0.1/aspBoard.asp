                ...
                <tr> 
                  <td width="100%">
					   ...
					   <!--#INCLUDE FILE="aspBoardFunctions.asp"-->
                        <font face="verdana" size=5><%=GetTitleString%></font> 
                        <br>
                        <b><font face="<%=abFont%>" size = 2><a class="black" href="aspBoardPost.asp?Id=0">Post 
                        a New Title</a></font></b> <br>
                        <%	
